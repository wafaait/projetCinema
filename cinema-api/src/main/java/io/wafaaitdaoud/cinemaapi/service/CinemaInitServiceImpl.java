package io.wafaaitdaoud.cinemaapi.service;

import io.wafaaitdaoud.cinemaapi.dao.*;
import io.wafaaitdaoud.cinemaapi.entity.*;
...
public class CinemaInitServiceImpl  implements ICinemaInitService {
    ...
    public void initMovies() {
        ...
        Stream.of("12 Hommes en Colaire","Forest Gump","La ligne Verte","le Parin","le Seigneur des anneaux").forEach(movieName -> {
            /*
